...
class VariablesMarket(Variables):
    ...
    curve_inflation_link : Mapped[List['CurveInflationLinkage']] = relationship(back_populates='variable')
...
class Curve(Base):
    ...
    derivatives : Mapped[List['BenchmarkDerivative']] = relationship(secondary=association_table2, back_populates='curves')
...
class CurveInflationLinkage(Base):
    ...
    variable : Mapped['VariablesMarket'] = relationship(back_populates='curve_inflation_link')
...
class BenchmarkDerivative(Base):
    ...
    curves : Mapped[List['Curve']] = relationship(secondary=association_table2, back_populates='derivatives')
