...
def upgrade() -> None:
    ...
    op.add_column(
        "SCHEDULE",
        sa.Column("terminationDateConvention_id", sa.Integer(), nullable=False),
        schema="DRIX",
    )
    op.drop_constraint(
        "FK__SCHEDULE__conven__00D5CB2D", "SCHEDULE", schema="DRIX", type_="foreignkey"
    )
    op.drop_constraint(
        "FK__SCHEDULE__termin__01C9EF66", "SCHEDULE", schema="DRIX", type_="foreignkey"
    )
    op.drop_constraint(
        "FK__SCHEDULE__freque__7FE1A6F4", "SCHEDULE", schema="DRIX", type_="foreignkey"
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "SCHEDULE",
        sa.Column("convention", sa.INTEGER(), autoincrement=False, nullable=False),
        schema="DRIX",
    )
    op.add_column(
        "SCHEDULE",
    ...
    op.drop_constraint(None, "SCHEDULE", schema="DRIX", type_="foreignkey")
    op.create_foreign_key(
        "FK__SCHEDULE__freque__7FE1A6F4",
        "SCHEDULE",
        "FREQUENCY",
        ["frequency"],
        ["id"],
    ...
    op.create_foreign_key(
        "FK__SCHEDULE__termin__01C9EF66",
        "SCHEDULE",
        "CONVENTION",
        ["terminationDateConvention"],
        ["id"],
    ...
    op.create_foreign_key(
        "FK__SCHEDULE__conven__00D5CB2D",
        "SCHEDULE",
        "CONVENTION",
        ["convention"],
        ["id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "maturity_risk_factor_id", sa.INTEGER(), autoincrement=False, nullable=True
        ),
        sa.ForeignKeyConstraint(
            ["index_id"], ["DRIX.INDEX.id"], name="FK__MATURITY___index__0E2FC64B"
        ),
        sa.ForeignKeyConstraint(
            ["maturity_risk_factor_id"],
            ["DRIX.MATURITY_RISK_FACTOR.id"],
            name="FK__MATURITY___matur__0F23EA84",
        ),
