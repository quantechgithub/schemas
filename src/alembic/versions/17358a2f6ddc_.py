...
down_revision: str | None = "120bf7db0da0"
...
def upgrade() -> None:
    ...
    op.add_column(
        "REBALANCING_RULES",
        sa.Column("issuer_type_id", sa.Integer(), nullable=True),
        schema="DRIX",
    )
    op.add_column(
        "REBALANCING_RULES",
    ...
    op.add_column(
        "REBALANCING_RULES",
        sa.Column("type_rate_id", sa.Integer(), nullable=True),
        schema="DRIX",
    )
    op.add_column(
        "REBALANCING_RULES",
    ...
    op.drop_constraint(
        "FK__REBALANCI__type___6AE68A0E",
        "REBALANCING_RULES",
        schema="DRIX",
        type_="foreignkey",
    )
    op.drop_constraint(
        "FK__REBALANCI__issue__68FE419C",
        "REBALANCING_RULES",
        schema="DRIX",
        type_="foreignkey",
    )
    op.drop_constraint(
        "FK__REBALANCI__curre__6BDAAE47",
        "REBALANCING_RULES",
        schema="DRIX",
        type_="foreignkey",
    )
    op.drop_constraint(
        "FK__REBALANCI__issue__69F265D5",
        "REBALANCING_RULES",
        schema="DRIX",
        type_="foreignkey",
    )
    ...
    op.add_column(
        "SCHEDULE", sa.Column("rule_id", sa.Integer(), nullable=False), schema="DRIX"
    )
    op.drop_constraint(
        "FK__SCHEDULE__rule__02BE139F", "SCHEDULE", schema="DRIX", type_="foreignkey"
    )
    op.create_foreign_key(
        None,
        "SCHEDULE",
...
def downgrade() -> None:
    ...
    op.add_column(
        "SCHEDULE",
        sa.Column("rule", sa.INTEGER(), autoincrement=False, nullable=False),
        schema="DRIX",
    )
    op.drop_constraint(None, "SCHEDULE", schema="DRIX", type_="foreignkey")
    op.create_foreign_key(
        "FK__SCHEDULE__rule__02BE139F",
        "SCHEDULE",
        "DATE_GENERATION_RULE",
        ["rule"],
        ["id"],
    ...
    op.add_column(
        "REBALANCING_RULES",
        sa.Column("type_rate", sa.INTEGER(), autoincrement=False, nullable=True),
        schema="DRIX",
    )
    op.add_column(
        "REBALANCING_RULES",
        sa.Column("issuer", sa.INTEGER(), autoincrement=False, nullable=True),
        schema="DRIX",
    )
    op.add_column(
        "REBALANCING_RULES",
        sa.Column("issuer_type", sa.INTEGER(), autoincrement=False, nullable=True),
        schema="DRIX",
    )
    op.add_column(
        "REBALANCING_RULES",
        sa.Column("currency", sa.INTEGER(), autoincrement=False, nullable=True),
        schema="DRIX",
    )
